<table class="form-table" role="presentation">
	...
	<tr>
		...
		<td>
			<input style="width:100%;" type="text" name="<?php echo $prefix; ?>_email_subject" id="<?php echo $prefix; ?>_email_subject" value="<?php esc_attr_e( $email_subject ); ?>"min="0" step="1" title="<?php esc_attr_e( 'The quantity of this resource available at any given time.', 'woocommerce-booking' ); ?>">
	...
	<tr>
		...
		<td>
			<input style="width:100%;"type="text" name="<?php echo $prefix; ?>_email_heading" id="<?php echo $prefix; ?>_email_heading" value="<?php esc_attr_e( $email_heading ); ?>"min="0" step="1" title="<?php esc_attr_e( 'The quantity of this resource available at any given time.', 'woocommerce-booking' ); ?>">
