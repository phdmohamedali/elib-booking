...
class Google_CurlIO implements Google_IO {
  ...
  public function makeRequest(Google_HttpRequest $request) {
    ...
    if (curl_errno($ch) == CURLE_SSL_CACERT) {
	  global $appointments;
      $appointments->log( __( 'Either 1) Connection error to Google server. You may neglect this message if it is happening sporadically, or 2) SSL certificate problem, verify that the CA cert is OK.', 'woocommerce-booking' ) );
