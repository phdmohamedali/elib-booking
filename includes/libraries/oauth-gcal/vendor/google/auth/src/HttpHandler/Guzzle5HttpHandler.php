...
use BKAPGuzzleHttp\Message\ResponseInterface as Guzzle5ResponseInterface;
use BKAPGuzzleHttp\Promise\Promise;
use BKAPGuzzleHttp\Promise\RejectedPromise;
...
class Guzzle5HttpHandler
{
    ...
    {
        if (!class_exists('BKAPGuzzleHttp\Promise\Promise')) {
