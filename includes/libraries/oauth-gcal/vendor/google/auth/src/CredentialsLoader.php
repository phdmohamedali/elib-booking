    ...
    UpdateMetadataInterface
{
    ...
    private static function getGuzzleMajorVersion()
    {
        ...
        if (defined('BKAPGuzzleHttp\ClientInterface::VERSION')) {
    ...
    public static function makeHttpClient(
        ...
        if (self::getGuzzleMajorVersion() === 5) {
            $client = new \BKAPGuzzleHttp\Client($httpClientOptions);
        ...
        $stack = \BKAPGuzzleHttp\HandlerStack::create();
        $stack->push($middleware);

        return new \BKAPGuzzleHttp\Client([
            'handler' => $stack,
            'auth' => 'google_auth',
        ] + $httpClientOptions);
    }
