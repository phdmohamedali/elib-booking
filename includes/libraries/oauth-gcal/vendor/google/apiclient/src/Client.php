...
use BKAPGoogle\AccessToken\Revoke;
use BKAPGoogle\AccessToken\Verify;
use BKAPGoogle\Auth\ApplicationDefaultCredentials;
...
use BKAPGoogle\AuthHandler\AuthHandlerFactory;
use BKAPGoogle\Http\REST;
use BKAPGuzzleHttp\Client as GuzzleClient;
use BKAPGuzzleHttp\ClientInterface;
use BKAPGuzzleHttp\Ring\Client\StreamHandler;
...
class Client
{
  ...
  {
    $guzzleVersion = null;
    if (defined('\BKAPGuzzleHttp\ClientInterface::MAJOR_VERSION')) {
      $guzzleVersion = ClientInterface::MAJOR_VERSION;
    } elseif (defined('\BKAPGuzzleHttp\ClientInterface::VERSION')) {
