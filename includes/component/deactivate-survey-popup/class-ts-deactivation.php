...
class Bkap_TS_deactivate {
	...
	public static function ts_load_all_str() {
		self::$ts_deactivation_str = array(
			'deactivation-share-reason'            => __( 'If you have a moment, please let us know why you are deactivating', 'woocommerce-booking' ),
			'deactivation-modal-button-submit'     => __( 'Submit & Deactivate', 'woocommerce-booking' ),
			'deactivation-modal-button-deactivate' => __( 'Deactivate', 'woocommerce-booking' ),
			'deactivation-modal-button-cancel'     => __( 'Cancel', 'woocommerce-booking' ),
			'deactivation-modal-button-confirm'    => __( 'Yes - Deactivate', 'woocommerce-booking' ),
		);

		self::$ts_generic_questions = array(
			'reason-found-a-better-plugin'             => __( 'I found a better plugin', 'woocommerce-booking' ),
			'placeholder-plugin-name'                  => __( "What's the plugin's name?", 'woocommerce-booking' ),
			'reason-needed-for-a-short-period'         => __( 'I only needed the plugin for a short period', 'woocommerce-booking' ),
			'reason-not-working'                       => __( 'The plugin is not working', 'woocommerce-booking' ),
			'placeholder-share-what-didnt-work'        => __( "Kindly share what didn't work so we can fix it for future users...", 'woocommerce-booking' ),
			'reason-great-but-need-specific-feature'   => __( "The plugin is great, but I need specific feature that you don't support", 'woocommerce-booking' ),
			'placeholder-feature'                      => __( 'What feature?', 'woocommerce-booking' ),
			'reason-dont-like-to-share-my-information' => __( "I don't like to share my information with you", 'woocommerce-booking' ),
			'reason-other'                             => _x( 'Other', "the text of the 'other' reason for deactivating the plugin that is shown in the modal box.", 'woocommerce-booking' ),
		);
	}
